...
public class MyEnvelopeDistance {
	/**
	 ...
	 */
	public static double maximumDistance(MyEnvelope env1, MyEnvelope env2) {
	 ...
	 */
	public static double minMaxDistance(MyEnvelope a, MyEnvelope b) {
